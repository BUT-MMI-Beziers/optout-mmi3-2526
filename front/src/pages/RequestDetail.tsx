    ...
    <div className="p-8 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="px-6 pb-5 space-y-2">
              ...
              {(request.status === 'NO_RESPONSE' || request.status === 'REFUSED') && (
                <Button
                  variant="outline"
                  className="w-full gap-2 h-10 border-red-200 text-red-600 hover:bg-red-50"
                >
      ...
      {emailPreview !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-popover rounded-xl border border-border shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col">
