        ...
        >
          ...
          <div className="flex items-start gap-3 pt-1">
            <button
              ...
              className={`
                ...
                ${accepted
                  ? 'bg-[#FC7E34] border-[#FC7E34]'
                  : 'border-border bg-muted/40 hover:border-[#FC7E34]/50'
                }
              `}
            >
              {accepted && (
          ...
          <div className="pt-2">
            <Button
              ...
              className="w-full h-11 bg-[#FC7E34] hover:bg-[#e06e28] text-white font-semibold disabled:opacity-50"
            >
          ...
          <p className="text-center text-xs text-muted-foreground pt-1">
            Déjà un compte ?{' '}
            <Link to="/login" className="text-[#FC7E34] font-medium hover:underline">
              Se connecter
            </Link>
          </p>
        </motion.form>
